...
standard_interval = 16              # standard interval between task in months
task_days = 15                      # number of days needed for a unit to perform a task
today =  datetime(2024,1,1)         # First day of the analysis
end_year = 2026                     # End year of the analysis
task_flexibility_down = 3           # range of weeks for the solution to explore down
task_flexibility_up = 3             # range of weeks for the solution to explore up
...
best_task_delta_weeks = 2           # best task delta weeks
unit_names = [
    'Worker 01', 
    'Worker 02', 
    'Worker 03', 
